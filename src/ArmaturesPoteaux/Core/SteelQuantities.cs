...
{
    /// <summary>Quantitatif d'acier d'un poteau : longueurs, poids et ratio.</summary>
    public class SteelQuantities
    {
        ...
        /// <summary>Ratio d'armature usuel en chiffrage (kg d'acier par m3 de beton).</summary>
