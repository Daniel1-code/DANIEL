        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var dialog = new TaskDialog("A propos")
            {
                ...
                MainContent =
                    ...
                    "Fonctions :" + Environment.NewLine +
                    "  - apercu graphique de la coupe avant generation ;" + Environment.NewLine +
                    "  - quantitatif d'acier (poids, longueurs de coupe, kg/m3) exportable en CSV ;" +
                    Environment.NewLine +
                    "  - verification de resistance en flexion composee avec second ordre, et" +
                    Environment.NewLine +
                    "    renforcement automatique tant que la section ne resiste pas ;" + Environment.NewLine +
                    "  - configurations enregistrees et rechargeables." + Environment.NewLine +
                    Environment.NewLine +
                    ...
                    "  - ACI 318-19 art. 10.6, 25.7.2 et 25.5.5 ;" + Environment.NewLine +
                    "  - verification N-M : EC2 art. 3.1.7, 5.8.8 (courbure nominale) et 5.8.9." +
